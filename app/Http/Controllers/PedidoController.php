...
class PedidoController extends Controller
{
    ...
    public function confirmar(): View|RedirectResponse
    {
        ...
        // Carga direcciones activas del usuario con su jerarquía geográfica
    ...
    public function procesar(Request $request): RedirectResponse
    {
        ...
        // Llama a sp_confirmar_pedido con parámetros OUT
        ...
        // Recupera los valores de los parámetros OUT desde MySQL
        ...
        // Verifica que el SP haya creado el pedido correctamente
        if (!$idPedido) {
            return back()->with('error', 'Ocurrió un error al procesar tu pedido. Intenta nuevamente.');
        }

        // Llama a sp_generar_factura con parámetro OUT
        ...
        // Redirige al detalle del pedido con mensaje de éxito
    ...
    /**
     * Muestra el detalle completo de un pedido del usuario autenticado.
    ...
    public function detalle(int $id_pedido): View
    {
        ...
        // Busca el pedido verificando que pertenece al usuario autenticado
        $pedido = Pedido::with([
                'estadoPedido',
                'items.producto',
